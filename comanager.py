...
wish_list = Feature(
    prefix="вишлист",
    button="Вишлист",
    descr="Создать вишлист, чтобы человек, которому вы выпали, видел ваши пожелания подарков на новый год. Чтобы "
          "создать вишлист напишите мне его одним сообщением с префиксом «вишлист», например «вишлист последний айфон»",
    text="Записал ваш вишлист: {0}\n\nПри жеребьевке покажу его тому, кто будет дарить вам подарок."
)
wish_list_error = Feature(
    text="Пустой вишлист. Чтобы создать вишлист напишите мне его одним сообщением с префиксом «вишлист», "
         "например «вишлист последний айфон»")
